...
// // SD0 // SDE // SDA // SA0 // SAE // SAA // RA0 // RAE // RAA // MD0 // MDE // MDA // SB1 // SB2 // SF // see explanation below
    ...
    {0.000, 8.510, 0.190, 0.610, 0.000, 0.000, 3.350, 0.000, 0.000, 0.750, 12.62, 0.060, 0.000, 0.000, 34.0}, // 4 <-- F "enmeshed_singularities"
    {0.000, 0.820, 0.030, 0.1800, 0.00, 0.000, 0.260, 0.000, 0.000, 0.000, 20.00, 0.650, 0.200, 0.900, 31.5}, // 5 <-- B "waves_upturn"
    {1.500, 1.940, 0.280, 1.730, 1.120, 0.710, 0.180, 2.220, 0.850, 0.500, 4.130, 0.110, 1.120, 0.000, 15.0}, // 6 <-- G "more_individuals"
    {2.870, 3.040, 0.280, 0.090, 0.000, 0.000, 0.440, 0.850, 0.000, 0.000, 2.220, 0.140, 0.300, 0.850, 11.0}, // 7 <-- I "sloppy_bucky"
    {0.140, 1.120, 0.190, 0.270, 1.400, 0.000, 1.130, 2.000, 0.390, 0.750, 2.220, 0.190, 0.000, 7.140, 9.00}, // 8 <-- J "massive_structure"
    {0.001, 2.540, 0.080, 0.000, 0.000, 0.000, 3.350, 0.000, 0.000, 0.100, 12.62, 0.060, 0.000, 0.000, 30.5}, // 9 <-- K "speed_modulation"
    {0.000, 28.04, 20.00, 0.180, 26.74, 20.00, 0.010, 1.400, 1.120, 0.830, 0.000, 0.000, 2.540, 0.000, 39.0}, // 10 <-- L "transmission_tower"
    ...
    {3.000, 9.000, 2.000, 0.000, 0.308, 0.000, 0.148, 13.00, 0.750, 0.830, 1.560, 0.110, 1.070, 0.040, 9.00}, // 17 <-- R
