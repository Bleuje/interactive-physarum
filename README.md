...
I'm using atomic counters on pixels and this is different. No fragment or vertex shader, only compute shader. I'm using the set of parameters from 36 Points. Currently, I'm using 19 points that seem to work quite well. Some work well, some don't, I had to tune stuff.
